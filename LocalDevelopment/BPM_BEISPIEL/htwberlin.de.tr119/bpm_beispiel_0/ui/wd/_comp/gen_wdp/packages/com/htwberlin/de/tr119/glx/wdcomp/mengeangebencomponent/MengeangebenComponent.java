...
// AT LEAST ONE IMPORT STATEMENT (E.G. THAT FOR IPrivateMengeangebenComponent).
// OTHERWISE, USING THE ECLIPSE FUNCTION "Organize Imports" FOLLOWED BY
// A WEB DYNPRO CODE GENERATION (E.G. PROJECT BUILD) WILL RESULT IN THE LOSS
// OF IMPORT STATEMENTS.
//
//@@begin imports
import com.htwberlin.de.tr119.glx.wdcomp.mengeangebencomponent.wdp.IPrivateMengeangebenComponent;
...
public class MengeangebenComponent implements java.io.Serializable 
{
  private static final long serialVersionUID = 0x424caf2ff4f53242L;
   ...
   * component usages.
   *
   * @see com.htwberlin.de.tr119.glx.wdcomp.mengeangebencomponent.wdp.IPrivateMengeangebenComponent for more details
   */
  @SuppressWarnings("unused")
  private final IPrivateMengeangebenComponent wdThis;
   ...
   *
   * @see com.htwberlin.de.tr119.glx.wdcomp.mengeangebencomponent.wdp.IPrivateMengeangebenComponent.IContextNode for more details.
   */
  @SuppressWarnings("unused")
  private final IPrivateMengeangebenComponent.IContextNode wdContext;
   ...
   */
  public MengeangebenComponent(IPrivateMengeangebenComponent wdThis)
  {
    this.wdThis = wdThis;
  ...
  //@@begin javadoc:fireMengeangebenCompleteEvent()
  /** 
   * Method declared by application. 
   */
  //@@end
  public void fireMengeangebenCompleteEvent( )  {
    //@@begin fireMengeangebenCompleteEvent()
    wdThis.wdFireEventMengeangebenCompleteEvent();
    //@@end
  }

  //@@begin javadoc:fireMengeangebenErrorEvent()
  /** 
   * Method declared by application. 
   */
  //@@end
  public void fireMengeangebenErrorEvent( )  {
    //@@begin fireMengeangebenErrorEvent()
    wdThis.wdFireEventMengeangebenErrorEvent();
    //@@end
  }
