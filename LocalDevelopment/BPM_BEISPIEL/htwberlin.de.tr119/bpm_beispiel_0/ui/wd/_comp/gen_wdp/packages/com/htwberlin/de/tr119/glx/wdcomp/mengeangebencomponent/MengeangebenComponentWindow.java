...
// AT LEAST ONE IMPORT STATEMENT (E.G. THAT FOR IPrivateMengeangebenComponentWindow).
// OTHERWISE, USING THE ECLIPSE FUNCTION "Organize Imports" FOLLOWED BY
// A WEB DYNPRO CODE GENERATION (E.G. PROJECT BUILD) WILL RESULT IN THE LOSS
// OF IMPORT STATEMENTS.
//
//@@begin imports
import com.htwberlin.de.tr119.glx.wdcomp.mengeangebencomponent.wdp.IPrivateMengeangebenComponentWindow;
...
public class MengeangebenComponentWindow implements java.io.Serializable 
{
  private static final long serialVersionUID = 0xc8317ffffe8c130L;
   ...
   * component usages.
   *
   * @see com.htwberlin.de.tr119.glx.wdcomp.mengeangebencomponent.wdp.IPrivateMengeangebenComponentWindow for more details
   */
  @SuppressWarnings("unused")
  private final IPrivateMengeangebenComponentWindow wdThis;
   ...
   *
   * @see com.htwberlin.de.tr119.glx.wdcomp.mengeangebencomponent.wdp.IPrivateMengeangebenComponentWindow.IContextNode for more details.
   */
  @SuppressWarnings("unused")
  private final IPrivateMengeangebenComponentWindow.IContextNode wdContext;
   ...
   */
  public MengeangebenComponentWindow(IPrivateMengeangebenComponentWindow wdThis)
  {
    this.wdThis = wdThis;
