...
public interface IPublicMengeangebenComponentWindow {
  ...
  {
    private static final long serialVersionUID = 0x373585aff5a1acecL;
    
    private InternalMengeangebenComponentWindow gen_delegate;

    IContextNode(InternalMengeangebenComponentWindow delegate, IGCINodeInfo nodeInfo, Node parent) {
    ...
    protected com.sap.tc.webdynpro.progmodel.context.Node createNode(IGCINodeInfo nodeInfo, com.sap.tc.webdynpro.progmodel.context.Node parentNode, com.sap.tc.webdynpro.progmodel.context.NodeElement parentElement) {
      if (nodeInfo == gen_delegate.infoContext)
        return new IPrivateMengeangebenComponentWindow.IContextNode(gen_delegate, nodeInfo, parentNode);
    ...
    protected com.sap.tc.webdynpro.progmodel.context.NodeElement doCreateElement(IGCINodeInfo nodeInfo, Object reference) {
      if (nodeInfo == gen_delegate.infoContext) {
        return new IPrivateMengeangebenComponentWindow.IContextElement(gen_delegate, nodeInfo);
      }
     ...
     */
    public IPrivateMengeangebenComponentWindow.IContextElement createContextElement() {
      return (IPrivateMengeangebenComponentWindow.IContextElement)createElement();
    }
     ...
     * @return an element for this node
     */
    public IPrivateMengeangebenComponentWindow.IContextElement createAndAddContextElement() {
      return (IPrivateMengeangebenComponentWindow.IContextElement)createAndAddElement();
    }
     ...
     */
    public void bind(IPrivateMengeangebenComponentWindow.IContextElement element) {
     ...
     */
    public IPrivateMengeangebenComponentWindow.IContextElement currentContextElement() {
      return (IPrivateMengeangebenComponentWindow.IContextElement) getCurrentElement();
    }
  ...
  {
    private static final long serialVersionUID = 0xdc4c8c2ff431323bL;
    
    private InternalMengeangebenComponentWindow gen_delegate;

    IContextElement(InternalMengeangebenComponentWindow delegate, com.sap.tc.webdynpro.progmodel.gci.IGCINodeInfo info) {
      super(info);
      gen_delegate = delegate;
    }
